...
/*   Updated: 2024/12/13 11:21:41 by welow            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// * @note 1. if player far from the start and end of minimap, it show a
// * 			portion of the map around the player.
// * @note	a. "size - pos" :: calculate the player distance from the end
// * 				of the map
// * @note	return: "pos - data->minimap.view_distance" :: calculate the
// * 			player distance
