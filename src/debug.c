...
/*   Updated: 2024/12/03 23:48:11 by welow            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void debug_parsing(t_data *data)
{
	...
	for(int i = 0; data->map.map_layout[i]; i++)
		printf("%s", data->map.map_layout[i]);
	printf("\n");

	printf("\nPLAYER\n");
	printf("player direction (char): %c\n", data->player.dir);
	printf("player position x (double): %f\n", data->player.pos_x);
	printf("player position y (double): %f\n", data->player.pos_y);
	printf("player direction x (double): %f\n", data->player.dir_x);
	printf("player direction y (double): %f\n", data->player.dir_y);
}
